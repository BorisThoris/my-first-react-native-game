...
## Problem
**Puzzle** pack **progression**, **medals**, and **curation** need clear unlock paths and author tooling expectations — not an endless unbounded `GP-22` wishlist. Connects to import (`REG-022`) and demo packaging (`REG-118`).
...
- Name medal rules, per-pack completion, and how puzzles appear in `REG-021` if tied to tasks.
- Cross-link `REG-022` and `REG-091` for shell routes to packs.

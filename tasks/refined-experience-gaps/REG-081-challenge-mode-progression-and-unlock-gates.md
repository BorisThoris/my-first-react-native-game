...
## Problem
**Challenge** modes, **progression** gates, and **unlock** rules need a table QA can test (entry conditions, lockouts, and save compatibility). Vague “hard mode later” does not hand off to a bot or `REG-119`.
...
- Cross-link `REG-013` (daily loop), `REG-019`, and `REG-032` (save/profile) for unlock source of truth.
- Keep gating **offline**-resolvable; defer online ladders per `REG-052`.

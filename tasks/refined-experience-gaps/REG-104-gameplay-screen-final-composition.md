...
## Problem
Final **gameplay** **screen** **composition** (HUD + board + toolbars) as one coherent **stage** at **Choose Path** quality — unifies `REG-003`–`REG-005` direction with the third-wave “final” ask.
...
- Reference `GameScreen` layout, `REG-105`–`REG-107` for sub-areas, and `REG-028` for regression harness.

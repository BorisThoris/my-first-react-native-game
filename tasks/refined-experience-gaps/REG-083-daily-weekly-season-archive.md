...
## Problem
**Daily**, **weekly**, and **season** archives (local history, comparison strings) need **offline**-safe identity and clock rules — extending `REG-023` and `REG-122` without inventing **online** leaderboards. This ticket is the **long-form** story for that loop.
...
- Reference `REG-023`, `REG-122`, and `SaveData` for history blobs; `REG-052` for online deferral of competitive boards.
- If share strings or exports exist, follow `REG-040` / `REG-063` (privacy).

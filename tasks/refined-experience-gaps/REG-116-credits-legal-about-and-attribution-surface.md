...
## Problem
**Credits** **legal** **about** surface — the player-trust and store-compliance home for `REG-057` / `REG-005` attribution and `REG-040` / `REG-030` legal placeholder slots.
...
- List owners for legal sign-off; `REG-040` / `REG-030` bot may not write final legal text; link `REG-061`+ store packaging.

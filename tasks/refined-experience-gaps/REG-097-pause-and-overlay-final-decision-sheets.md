...
## Problem
**Pause** and **overlay** **decision sheets** (relic pick, event choice, run settings) need consistent chrome, back behavior, and **one-hand** + **keyboard** paths — central to `REG-080`–`REG-100` overlay work.
...
- Link to `REG-097`, `REG-013`, and `REG-043` pause; `REG-029` a11y for modals; `REG-099` for stack discipline.

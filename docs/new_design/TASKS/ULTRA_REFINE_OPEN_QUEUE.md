...
|----------|-----------|--------------|
| **P0** | `PLAY-010` (evidence / HUD-board captures) | [`PLAYING_ENDPRODUCT/README.md`](./PLAYING_ENDPRODUCT/README.md) |
| **P1 (HUD)** | `HUD-007`–`HUD-014`, `HUD-018`, `HUD-019` | [`TASKS_HUD_PARITY.md`](./TASKS_HUD_PARITY.md) |
| **P1 (playing)** | `PLAY-003`, `PLAY-007` | [`PLAYING_ENDPRODUCT/README.md`](./PLAYING_ENDPRODUCT/README.md) |

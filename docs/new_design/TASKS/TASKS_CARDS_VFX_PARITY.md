...
- **Missing vs mockup (remaining):** Heavy shared hover spec DOM↔WebGL, stronger **match particles**, optional **bloom** (gated by quality); see active `FX-*` / `CARD-*` rows below.
...
| FX-006 | P2 | WebGL hover gold rim | Emissive/rim aligned with DOM hover tokens. | [`HOVER_DOM_WEBGL_TOKENS.md`](../HOVER_DOM_WEBGL_TOKENS.md) documents parity. | — |
...
**CARD-001**, **FX-004**, and **FX-016** (policy doc) are closed; schedule **FX-005** / further **CARD-*** work after verifying rows in [`FX_REDUCE_MOTION_MATRIX.md`](../FX_REDUCE_MOTION_MATRIX.md).

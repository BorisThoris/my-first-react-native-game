...
For a concise map of **current imports** and where to place final art without rewiring components, see [DROP_IN_ASSET_CHECKLIST.md](DROP_IN_ASSET_CHECKLIST.md) (supports **TASK-009**, **TASK-010**, **`PLAY-007`** / **`PLAYING_ENDPRODUCT/05-cards.md`**, and **TASK-018**).

...
**Start at the internal wiki:** [internal-wiki/README.md](./internal-wiki/README.md) — single map of gameplay specs, UI/design backlog, engineering notes, capture workflows, and where truth lives in code.

**Coverage / completeness (what “90–100%” means here):** [internal-wiki/COVERAGE.md](./internal-wiki/COVERAGE.md).

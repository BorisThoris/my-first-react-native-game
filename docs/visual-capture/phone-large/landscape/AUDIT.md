# Visual audit: phone-large / landscape

- **Device folder:** `phone-large`
- **Orientation:** landscape
- **Relative path:** `docs/visual-capture/phone-large/landscape`

## Screenshots

| File | Dimensions | Screen | Slug |
| --- | --- | --- | --- |
| `00-startup-intro.png` | 932×430 | Startup relic intro | `00-startup-intro` |
| `01-main-menu.png` | 932×430 | Main menu | `01-main-menu` |
| `01a-choose-your-path.png` | 932×430 | Choose Your Path | `01a-choose-your-path` |
| `01b-collection.png` | 932×430 | Collection | `01b-collection` |
| `01c-inventory-empty.png` | 932×430 | Inventory (no active run) | `01c-inventory-empty` |
| `01d-inventory-active.png` | 932×430 | Inventory (active run) | `01d-inventory-active` |
| `01e-codex.png` | 932×430 | Codex | `01e-codex` |
| `02-main-menu-howto.png` | 932×430 | Main menu with How To Play | `02-main-menu-howto` |
| `03-settings-page.png` | 932×430 | Settings (full page) | `03-settings-page` |
| `04-game-playing.png` | 932×430 | Level 1 play (board visible) | `04-game-playing` |
| `05-pause-modal.png` | 932×430 | Pause modal | `05-pause-modal` |
| `06-run-settings-modal.png` | 932×430 | Run settings (in-game modal) | `06-run-settings-modal` |
| `07-floor-cleared-modal.png` | 932×430 | Floor cleared modal | `07-floor-cleared-modal` |
| `08-game-over.png` | 932×430 | Game over / Expedition Over | `08-game-over` |

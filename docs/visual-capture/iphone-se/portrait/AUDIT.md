# Visual audit: iphone-se / portrait
...
- **Relative path:** `docs/visual-capture/iphone-se/portrait`

## Screenshots

| File | Dimensions | Screen | Slug |
| --- | --- | --- | --- |
| `00-startup-intro.png` | 375×667 | Startup relic intro | `00-startup-intro` |
| `01-main-menu.png` | 375×667 | Main menu | `01-main-menu` |
| `01a-choose-your-path.png` | 375×667 | Choose Your Path | `01a-choose-your-path` |
| `01b-collection.png` | 375×667 | Collection | `01b-collection` |
| `01c-inventory-empty.png` | 375×667 | Inventory (no active run) | `01c-inventory-empty` |
| `01d-inventory-active.png` | 375×667 | Inventory (active run) | `01d-inventory-active` |
| `01e-codex.png` | 375×667 | Codex | `01e-codex` |
| `02-main-menu-howto.png` | 375×667 | Main menu with How To Play | `02-main-menu-howto` |
| `03-settings-page.png` | 375×667 | Settings (full page) | `03-settings-page` |
| `04-game-playing.png` | 375×667 | Level 1 play (board visible) | `04-game-playing` |
| `05-pause-modal.png` | 375×667 | Pause modal | `05-pause-modal` |
| `06-run-settings-modal.png` | 375×667 | Run settings (in-game modal) | `06-run-settings-modal` |
| `07-floor-cleared-modal.png` | 375×667 | Floor cleared modal | `07-floor-cleared-modal` |
| `08-game-over.png` | 375×667 | Game over / Expedition Over | `08-game-over` |

# Visual audit: pixel-7 / landscape

- **Device folder:** `pixel-7`
- **Orientation:** landscape
- **Relative path:** `docs/visual-capture/pixel-7/landscape`

## Screenshots

| File | Dimensions | Screen | Slug |
| --- | --- | --- | --- |
| `00-startup-intro.png` | 851×393 | Startup relic intro | `00-startup-intro` |
| `01-main-menu.png` | 851×393 | Main menu | `01-main-menu` |
| `01a-choose-your-path.png` | 851×393 | Choose Your Path | `01a-choose-your-path` |
| `01b-collection.png` | 851×393 | Collection | `01b-collection` |
| `01c-inventory-empty.png` | 851×393 | Inventory (no active run) | `01c-inventory-empty` |
| `01d-inventory-active.png` | 851×393 | Inventory (active run) | `01d-inventory-active` |
| `01e-codex.png` | 851×393 | Codex | `01e-codex` |
| `02-main-menu-howto.png` | 851×393 | Main menu with How To Play | `02-main-menu-howto` |
| `03-settings-page.png` | 851×393 | Settings (full page) | `03-settings-page` |
| `04-game-playing.png` | 851×393 | Level 1 play (board visible) | `04-game-playing` |
| `05-pause-modal.png` | 851×393 | Pause modal | `05-pause-modal` |
| `06-run-settings-modal.png` | 851×393 | Run settings (in-game modal) | `06-run-settings-modal` |
| `07-floor-cleared-modal.png` | 851×393 | Floor cleared modal | `07-floor-cleared-modal` |
| `08-game-over.png` | 851×393 | Game over / Expedition Over | `08-game-over` |

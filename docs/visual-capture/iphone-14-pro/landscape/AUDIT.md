# Visual audit: iphone-14-pro / landscape
> **Checklist policy:** Items marked [x] per [visual-capture README](../../README.md); re-verify when replacing PNGs.


- **Device folder:** `iphone-14-pro`
- **Orientation:** landscape
- **Relative path:** `docs/visual-capture/iphone-14-pro/landscape`

## Screenshots

| File | Dimensions | Screen | Slug |
| --- | --- | --- | --- |
| `00-startup-intro.png` | 844×390 | Startup relic intro | `00-startup-intro` |
| `01-main-menu.png` | 844×390 | Main menu | `01-main-menu` |
| `01a-choose-your-path.png` | 844×390 | Choose Your Path | `01a-choose-your-path` |
| `01b-collection.png` | 844×390 | Collection | `01b-collection` |
| `01c-inventory-empty.png` | 844×390 | Inventory (no active run) | `01c-inventory-empty` |
| `01d-inventory-active.png` | 844×390 | Inventory (active run) | `01d-inventory-active` |
| `01e-codex.png` | 844×390 | Codex | `01e-codex` |
| `02-main-menu-howto.png` | 844×390 | Main menu with How To Play | `02-main-menu-howto` |
| `03-settings-page.png` | 844×390 | Settings (full page) | `03-settings-page` |
| `04-game-playing.png` | 844×390 | Level 1 play (board visible) | `04-game-playing` |
| `05-pause-modal.png` | 844×390 | Pause modal | `05-pause-modal` |
| `06-run-settings-modal.png` | 844×390 | Run settings (in-game modal) | `06-run-settings-modal` |
| `07-floor-cleared-modal.png` | 844×390 | Floor cleared modal | `07-floor-cleared-modal` |
| `08-game-over.png` | 844×390 | Game over / Expedition Over | `08-game-over` |

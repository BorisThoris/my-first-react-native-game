# Visual audit: iphone-14-pro / portrait

- **Device folder:** `iphone-14-pro`
- **Orientation:** portrait
- **Relative path:** `docs/visual-capture/iphone-14-pro/portrait`

## Screenshots

| File | Dimensions | Screen | Slug |
| --- | --- | --- | --- |
| `00-startup-intro.png` | 390×844 | Startup relic intro | `00-startup-intro` |
| `01-main-menu.png` | 390×844 | Main menu | `01-main-menu` |
| `01a-choose-your-path.png` | 390×844 | Choose Your Path | `01a-choose-your-path` |
| `01b-collection.png` | 390×844 | Collection | `01b-collection` |
| `01c-inventory-empty.png` | 390×844 | Inventory (no active run) | `01c-inventory-empty` |
| `01d-inventory-active.png` | 390×844 | Inventory (active run) | `01d-inventory-active` |
| `01e-codex.png` | 390×844 | Codex | `01e-codex` |
| `02-main-menu-howto.png` | 390×844 | Main menu with How To Play | `02-main-menu-howto` |
| `03-settings-page.png` | 390×844 | Settings (full page) | `03-settings-page` |
| `04-game-playing.png` | 390×844 | Level 1 play (board visible) | `04-game-playing` |
| `05-pause-modal.png` | 390×844 | Pause modal | `05-pause-modal` |
| `06-run-settings-modal.png` | 390×844 | Run settings (in-game modal) | `06-run-settings-modal` |
| `07-floor-cleared-modal.png` | 390×844 | Floor cleared modal | `07-floor-cleared-modal` |
| `08-game-over.png` | 390×844 | Game over / Expedition Over | `08-game-over` |

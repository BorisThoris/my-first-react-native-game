# Visual audit: desktop-1280 / portrait

- **Device folder:** `desktop-1280`
- **Orientation:** portrait
- **Relative path:** `docs/visual-capture/desktop-1280/portrait`

## Screenshots

| File | Dimensions | Screen | Slug |
| --- | --- | --- | --- |
| `00-startup-intro.png` | 720×1280 | Startup relic intro | `00-startup-intro` |
| `01-main-menu.png` | 720×1280 | Main menu | `01-main-menu` |
| `01a-choose-your-path.png` | 720×1280 | Choose Your Path | `01a-choose-your-path` |
| `01b-collection.png` | 720×1280 | Collection | `01b-collection` |
| `01c-inventory-empty.png` | 720×1280 | Inventory (no active run) | `01c-inventory-empty` |
| `01d-inventory-active.png` | 720×1280 | Inventory (active run) | `01d-inventory-active` |
| `01e-codex.png` | 720×1280 | Codex | `01e-codex` |
| `02-main-menu-howto.png` | 720×1280 | Main menu with How To Play | `02-main-menu-howto` |
| `03-settings-page.png` | 720×1280 | Settings (full page) | `03-settings-page` |
| `04-game-playing.png` | 720×1280 | Level 1 play (board visible) | `04-game-playing` |
| `05-pause-modal.png` | 720×1280 | Pause modal | `05-pause-modal` |
| `06-run-settings-modal.png` | 720×1280 | Run settings (in-game modal) | `06-run-settings-modal` |
| `07-floor-cleared-modal.png` | 720×1280 | Floor cleared modal | `07-floor-cleared-modal` |
| `08-game-over.png` | 720×1280 | Game over / Expedition Over | `08-game-over` |

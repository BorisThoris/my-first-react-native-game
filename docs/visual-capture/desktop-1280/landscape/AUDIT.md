# Visual audit: desktop-1280 / landscape

- **Device folder:** `desktop-1280`
- **Orientation:** landscape
- **Relative path:** `docs/visual-capture/desktop-1280/landscape`

## Screenshots

| File | Dimensions | Screen | Slug |
| --- | --- | --- | --- |
| `00-startup-intro.png` | 1280×720 | Startup relic intro | `00-startup-intro` |
| `01-main-menu.png` | 1280×720 | Main menu | `01-main-menu` |
| `01a-choose-your-path.png` | 1280×720 | Choose Your Path | `01a-choose-your-path` |
| `01b-collection.png` | 1280×720 | Collection | `01b-collection` |
| `01c-inventory-empty.png` | 1280×720 | Inventory (no active run) | `01c-inventory-empty` |
| `01d-inventory-active.png` | 1280×720 | Inventory (active run) | `01d-inventory-active` |
| `01e-codex.png` | 1280×720 | Codex | `01e-codex` |
| `02-main-menu-howto.png` | 1280×720 | Main menu with How To Play | `02-main-menu-howto` |
| `03-settings-page.png` | 1280×720 | Settings (full page) | `03-settings-page` |
| `04-game-playing.png` | 1280×720 | Level 1 play (board visible) | `04-game-playing` |
| `05-pause-modal.png` | 1280×720 | Pause modal | `05-pause-modal` |
| `06-run-settings-modal.png` | 1280×720 | Run settings (in-game modal) | `06-run-settings-modal` |
| `07-floor-cleared-modal.png` | 1280×720 | Floor cleared modal | `07-floor-cleared-modal` |
| `08-game-over.png` | 1280×720 | Game over / Expedition Over | `08-game-over` |

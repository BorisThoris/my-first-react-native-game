        ...
        <View style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.legend}>
                    ...
                    <Text style={styles.legendItem}>🛒 Shop (Buy Items)</Text>
                    <Text style={styles.legendItem}>🔍 Secret Room (Use Bomb)</Text>
                    <Text style={styles.legendItem}>📚 Library (Item Focus)</Text>
                    <Text style={styles.legendItem}>⚔️ Challenge (High Reward)</Text>
                    <Text style={styles.legendItem}>😈 Devil Room (Powerful Items)</Text>
                    <Text style={styles.legendItem}>😇 Angel Room (Free Items)</Text>
